...
export interface GenerateResult { text: string; provider: ProviderName; accountId: string; model: string; usage: Usage; requestId: string; latencyMs: number; }
...
export interface ProviderAdapter {
  ...
  generate(account: AccountConfig, request: GenerateRequest, model: string, credential: string, requestId: string): Promise<GenerateResult>;
  stream(account: AccountConfig, request: GenerateRequest, model: string, credential: string, requestId: string): AsyncIterable<StreamChunk>;
  discoverModels(account: AccountConfig, credential: string): Promise<string[]>;
